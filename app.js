...
async function gerarDasAutomatico() {
    ...
    try {
        ...
        if (!res.ok) throw new Error(data.erro || 'Falha na automa��o.');

        resDiv.innerHTML = \
            <div style="text-align:left; width:100%;">
                <h3 style="color:#34d399;margin-bottom:12px;">? DAS Gerado com Sucesso!</h3>
                <p style="font-size:13px;margin-bottom:8px;"><strong>Per�odo:</strong> \</p>
                ...
                <p style="font-size:12px;color:var(--text-muted);margin-bottom:16px;">Al�quota efetiva: \% | Vencimento: \</p>
                
                <div style="background:var(--bg-secondary);padding:12px;border-radius:8px;margin-bottom:16px;">
                    <label style="font-size:10px;color:var(--text-muted);display:block;margin-bottom:4px;">C�DIGO PIX PARA PAGAMENTO</label>
                    <code style="font-size:10px;word-break:break-all;color:var(--color-primary);">\</code>
                </div>
                <button class="btn-primary" style="width:100%;" onclick="alert('Funcionalidade de download em implementa��o...')">Baixar PDF da Guia</button>
            </div>
        \;
    } catch (e) {
