...
(function() {
    const functions = [
        'openModal', 'closeModal', 'setTab', 'switchView', 'logoutCliente', 
        'conectarBanco', 'syncBank', 'disconnectBank', 'calcularDAS', 
        'simularRegime', 'gerarDasAutomatico', 'loginWithCnpj', 'registerWithCnpj',
        'sendLoginCode', 'verifyLoginCode', 'buscarCnpjNaReceita', 'goTab',
        'processarOCR', 'toggleTheme', 'copyPix', 'initApp', 'carregarHistoricoAnalises',
        'updateAuthState', 'loadDashboard', 'loadCharts', 'loadMoMComparison'
    ];
    functions.forEach(fn => {
        try {
            if (typeof window[fn] === 'undefined') {
                const func = eval(fn);
                if (typeof func === 'function') window[fn] = func;
            }
        } catch(e) {}
    });
    // Inicializar o app
